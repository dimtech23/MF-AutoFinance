...
export declare const restoreClient: (req: Request, res: Response) => Promise<Response>;
...
export declare const generateCompletionPDF: (req: Request, res: Response) => Promise<Response>;
export declare const getClientAuditLogs: (req: Request, res: Response) => Promise<Response>;
