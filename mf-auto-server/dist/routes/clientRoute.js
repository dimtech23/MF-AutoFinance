...
router.get('/:id/audit-logs', (0, authMiddleware_1.authorize)([roles_1.UserRole.ADMIN]), clientController_1.getClientAuditLogs);
...
router.patch('/:id/restore', (0, authMiddleware_1.authorize)([roles_1.UserRole.ADMIN]), clientController_1.restoreClient);
...
router.get('/:id/completion-pdf', clientController_1.generateCompletionPDF);
